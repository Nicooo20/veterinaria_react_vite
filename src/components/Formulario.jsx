...
const Formulario = ({ pacientes, setPacientes, paciente, setPaciente }) => {
    ...
    }, [paciente]) //se ejecutara cuando paciente haya cambiado o se haya creado
    ...
    return (
        <div className="md:w-1/2 lg:w-2/5 mx-5">
            ...
            >
                ...
                <div className="mb-5">
                    <label htmlFor="alta" className="block text-black uppercase font-bold">
                        Alta
                    </label>
                    <input
                        id="alta"
                ...
                <input
                    ...
                    value={ paciente.id ? 'Editar Paciente' : 'Agregar Paciente' } //si existe un paciente entonces ... si no ...
                />
            </form>
        </div>
    )
